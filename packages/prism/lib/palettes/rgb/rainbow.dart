...
/// RGB-based Spectrum enum for the Rainbow palette.
/// Each enum value implements Spectrum directly for clean API access.
enum RainbowRgb implements PrismPalette {
  pink(
...
;
  ...
  const RainbowRgb(this.source, this.spectrum);
  ...
  static RayWithLuminance<RayRgb8> get black => _RainbowRgbFixedRays.black.ray;
  static RayWithLuminance<RayRgb8> get white => _RainbowRgbFixedRays.white.ray;
