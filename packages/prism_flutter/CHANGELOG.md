...
- Added `Beam.toLinearGradient()` — densifies a `Beam` into a Flutter `LinearGradient` (GPU sRGB stop-interpolation approximates the perceptual path)
- Requires Prism 2.2.0 (`Beam`)
